  ...
  return (
    <div className="bg-black text-white w-full rounded-lg h-[300px] border-[1px] border-[#272727] ">
      <div className="flex xlg:flex-row flex-col xlg:gap-[0] gap-[52px]">
        ...
        <div className="bg-black xlg:w-1/2 xlg:ps-[50px] ps-[21px] xlg:pt-[29px] pt-[10px] xlg:pb-[0px] pb-[10px] pe-[21px] xlg:border-[0px] rounded-lg border-[1px] border-[#272727]">
